...
namespace Tail_Api
{
    ...
    //    private double _tokenExpireDuration = 3;//Default is 3 min
    ...
    //    public string TokenSecret => _tokenSecret;

    //    public double TokenExpireDuration => _tokenExpireDuration;

    //    internal ApplicationSetting(int dBAgeInPatchesApplicableForAutoPatching, int e2SourceApplicationId,
    //        string cs, string csro, string tokenSecret)
    //    {
